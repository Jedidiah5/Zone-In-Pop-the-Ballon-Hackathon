...
function getPotentialConfig(potential: Zone["potential"]) {
  switch (potential) {
    ...
    case "medium":
      return {
        label: "Medium",
        className: "border-[#CCCCCC] bg-[#F0F0F0] text-black",
      };
    case "low":
      return {
        label: "Low",
        className: "border-[#E5E5E5] bg-white text-[#666666]",
      };
  }
}
    ...
    return (
      <AppLayout>
        <div className="page-shell-wide flex min-h-[70dvh] flex-col py-6">
          <button
            className="mb-8 flex touch-manipulation items-center gap-3 text-sm font-bold text-[#666666] active:opacity-80"
  ...
  return (
    <AppLayout>
      <div className="page-shell-wide pb-32 py-6 lg:max-w-4xl lg:pb-10 lg:py-10">
        <button
          className="mb-5 flex touch-manipulation items-center gap-3 text-sm font-bold text-[#666666] active:opacity-80"
          onClick={() => router.push("/zones")}
          type="button"
        >
          <ArrowLeft aria-hidden="true" size={22} strokeWidth={2.5} />
        ...
        <header className="mb-6">
          ...
          <p className="mt-2 text-sm text-[#666666]">{zone.distance}</p>
          <div
        ...
        <section className="mb-5 grid grid-cols-3 gap-3">
          <div className="bolt-card p-4">
            <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.12em] text-[#666666]">
              Surge
            </p>
        ...
        <section className="bolt-card p-5">
          ...
          <div className="space-y-3 text-sm font-bold text-[#666666]">
            ...
            <div className="flex items-start justify-between gap-4 border-b border-[#E5E5E5] pb-3">
              ...
              <span className="max-w-[180px] text-right text-black">
                Avoid blocked side roads after pickups
              </span>
            </div>
            <div className="flex items-start justify-between gap-4">
              <span>Peak end time</span>
              <span className="text-black">{zone.peakEndTime}</span>
            </div>
          </div>
        </section>
      </div>
      ...
      <div className="fixed bottom-[5.5rem] left-4 right-4 z-40 lg:bottom-8 lg:left-auto lg:right-8 lg:max-w-md">
        <button
          className="bolt-btn-primary gap-2 shadow-[0_4px_20px_rgba(0,0,0,0.12)]"
